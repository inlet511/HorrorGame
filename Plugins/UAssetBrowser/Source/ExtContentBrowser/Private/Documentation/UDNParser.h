 ...
 */
class FExtUDNParser : public TSharedFromThis< FExtUDNParser >
{
public:

	static TSharedRef< FExtUDNParser > Create( const TSharedPtr< FParserConfiguration >& ParserConfig, const FDocumentationStyle& Style );
...
public:
	...
	bool GetExcerptContent( const FString& Link, FExcerpt& Excerpt, bool bInSimpleText = false );
...
private:
	...
	FExtUDNParser( const TSharedRef< FParserConfiguration >& InConfiguration, const FDocumentationStyle& InStyle );
	void Initialize();
