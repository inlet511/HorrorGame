...
bool UAssetBrowserDOC::FExtDocumentationRedirectRegistry::Register(const FName& Owner, const FDocumentationRedirect& Redirect)
{
...
void UAssetBrowserDOC::FExtDocumentationRedirectRegistry::UnregisterAll(const FName& Owner)
{
...
bool UAssetBrowserDOC::FExtDocumentationRedirectRegistry::GetRedirect(const FString& Link, FDocumentationRedirect& OutRedirect) const
{
