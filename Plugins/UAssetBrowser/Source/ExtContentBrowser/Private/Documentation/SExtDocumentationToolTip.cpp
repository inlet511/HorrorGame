...
void UAssetBrowserDOC::SExtDocumentationToolTip::Construct( const FArguments& InArgs )
{
...
void UAssetBrowserDOC::SExtDocumentationToolTip::ConstructSimpleTipContent()
{
...
void UAssetBrowserDOC::SExtDocumentationToolTip::AddDocumentation(TSharedPtr< SVerticalBox > VerticalBox)
{
	if ( !DocumentationLink.IsEmpty() )
	{
		...
		else
		{
			if ( IsDisplayingDocumentationLink && FSlateApplication::Get().SupportsSourceAccess() )
			{
				...
				[
					...
					.OnNavigate( this, &UAssetBrowserDOC::SExtDocumentationToolTip::CreateExcerpt, DocPath, ExcerptName )
				];
			}
		}
	}
...
void UAssetBrowserDOC::SExtDocumentationToolTip::CreateExcerpt( FString FileSource, FString InExcerptName )
{
...
void UAssetBrowserDOC::SExtDocumentationToolTip::ConstructFullTipContent()
{
...
FReply UAssetBrowserDOC::SExtDocumentationToolTip::ReloadDocumentation()
{
...
void UAssetBrowserDOC::SExtDocumentationToolTip::Tick( const FGeometry& AllottedGeometry, const double InCurrentTime, const float InDeltaTime )
{
...
bool UAssetBrowserDOC::SExtDocumentationToolTip::IsInteractive() const
{
	const FModifierKeysState ModifierKeys = FSlateApplication::Get().GetModifierKeys();
