...
TSharedRef<SWidget> SExtContentBrowser::CreateChangeLogWidget()
{
	...
	const UAssetBrowserDOC::IDocumentationProvider* Provider = UAssetBrowserDOC::FDocumentationProvider::Get().GetProvider(FName(*UAssetBrowserDOC::DocumentationHostPluginName));
