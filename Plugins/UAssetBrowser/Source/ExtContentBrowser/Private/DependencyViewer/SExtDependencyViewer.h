...
private:
	...
	/** Handle selection change in the content browser */
	void OnSelectedAssetsChanged(const TArray<FExtAssetData>& NewSelectedAssets, bool bIsPrimaryBrowser);
...
ENUM_CLASS_FLAGS(EExtDependencyPinCategory);

extern EExtDependencyPinCategory ParseDependencyPinCategory(FName PinCategory);
extern FLinearColor GetColor(EExtDependencyPinCategory Category);
extern FName GetName(EExtDependencyPinCategory Category);